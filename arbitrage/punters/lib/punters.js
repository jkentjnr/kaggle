...
exports.getFriendlyName = function(type) {
  switch (type) {
...
exports.getSportsType = function(type) {
  switch (type) {
    case 'horseRacing': return exports.SPORT_TYPE_HORSE_RACING;
    case 'soccer': return exports.SPORT_TYPE_SOCCER;
    case 'afl': return exports.SPORT_TYPE_AFL;
    case 'rugbyLeague': return exports.SPORT_TYPE_RUGBY_LEAGUE;
    case 'rugbyUnion': return exports.SPORT_TYPE_RUGBY_UNION;
    case 'carRacing': return exports.SPORT_TYPE_CAR_RACING;
    case 'golf': return exports.SPORT_TYPE_GOLF;
    case 'tennis': return exports.SPORT_TYPE_TENNIS;
    case 'cricket': return exports.SPORT_TYPE_CRICKET;
    case 'basketball': return exports.SPORT_TYPE_BASKETBALL;
    default: throw new Error('Invalid Sport Type');
  }
}
...
exports.getOdds = function(params) {
  return new Promise(function (resolve, reject) {
    ...
    job.on('task:GetOdds:success', function (jobResult) {
      result.sports[exports.getFriendlyName(jobResult.data[0].sport)] = jobResult.data;
